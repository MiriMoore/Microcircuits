...
#===========================================================================
# added print to each inhibcell
#removed run_circuit_functions, plotting
...
inhibcell = str(sys.argv[2])
reduce_inhib = float(sys.argv[3])              # %reduction in inhibition
syn_inhib = 1 - reduce_inhib
gtonic_inhib = reduce_inhib

if inhibcell=='HL23MN1':
    outputpath = '/scratch/e/etayhay/frankm/Mazza2022_output/SST/'+str(sys.argv[4])
    
if inhibcell=='HL23BN1':
    outputpath = '/scratch/e/etayhay/frankm/Mazza2022_output/PV/'+str(sys.argv[4])
    
print('inhibcell',type(inhibcell),'reduce_inhib', type(reduce_inhib))
print('Inhibcell =', inhibcell,'',reduce_inhib,'% reduction')
...
if MDD:
	...
	if inhibcell=='HL23BN1':
		if RANK==0:
			print('Inhibcell=',inhibcell)
			print('>>>Synaptic conductances')
			print('Healthy PV > Pyr =',syn_params['HL23BN1HL23PN1']['gmax'])
			print('Healthy PV > SST =',syn_params['HL23BN1HL23MN1']['gmax'])
			print('Healthy PV > PV =',syn_params['HL23BN1HL23BN1']['gmax'])
			print('Healthy PV > VIP =',syn_params['HL23BN1HL23VN1']['gmax'])

			print('Synaptic conductances will be ',syn_inhib*100,'% of their original value' )
			print('New PV > Pyr =',syn_params['HL23BN1HL23PN1']['gmax']*syn_inhib)
			print('New PV > SST =',syn_params['HL23BN1HL23MN1']['gmax']*syn_inhib)
			print('New PV > PV =',syn_params['HL23BN1HL23BN1']['gmax']*syn_inhib)
			print('New PV > VIP =',syn_params['HL23BN1HL23VN1']['gmax']*syn_inhib)

		syn_params['HL23BN1HL23PN1']['gmax'] = syn_params['HL23BN1HL23PN1']['gmax']*syn_inhib
		syn_params['HL23BN1HL23MN1']['gmax'] = syn_params['HL23BN1HL23MN1']['gmax']*syn_inhib
		syn_params['HL23BN1HL23BN1']['gmax'] = syn_params['HL23BN1HL23BN1']['gmax']*syn_inhib
		syn_params['HL23BN1HL23VN1']['gmax'] = syn_params['HL23BN1HL23VN1']['gmax']*syn_inhib

		if RANK==0:
			print('\n>>>Tonic Conductances (affecting basal and soma')
			print('Healthy Pyr ',Gtonic_PN)
			print('Healthy SST ',Gtonic_MN)
			print('Healthy PV ',Gtonic_BN)
			print('Healthy VIP',Gtonic_VN)


		Gtonic_PN -= Gtonic_PN*gtonic_inhib
		Gtonic_MN -= (Ncont_BN2MN*con_BN2MN*connection_prob['HL23BN1HL23MN1'])/(Ncont_BN2MN*con_BN2MN*connection_prob['HL23BN1HL23MN1']+Ncont_VN2MN*con_VN2MN*connection_prob['HL23VN1HL23MN1']+Ncont_MN2MN*con_MN2MN*connection_prob['HL23MN1HL23MN1'])*Gtonic_MN*gtonic_inhib
		Gtonic_BN -= (Ncont_BN2BN*con_BN2BN*connection_prob['HL23BN1HL23BN1'])/(Ncont_BN2BN*con_BN2BN*connection_prob['HL23BN1HL23BN1']+Ncont_VN2BN*con_VN2BN*connection_prob['HL23VN1HL23BN1']+Ncont_MN2BN*con_MN2BN*connection_prob['HL23MN1HL23BN1'])*Gtonic_BN*gtonic_inhib
		Gtonic_VN -= (Ncont_BN2VN*con_BN2VN*connection_prob['HL23BN1HL23VN1'])/(Ncont_BN2VN*con_BN2VN*connection_prob['HL23BN1HL23VN1']+Ncont_VN2VN*con_VN2VN*connection_prob['HL23VN1HL23VN1']+Ncont_MN2VN*con_MN2VN*connection_prob['HL23MN1HL23VN1'])*Gtonic_VN*gtonic_inhib

		if RANK==0:
			print('PN tonic reduced by ',gtonic_inhib*100, '%')
			print('MN tonic reduced by ',(Ncont_BN2MN*con_BN2MN*connection_prob['HL23BN1HL23MN1'])/(Ncont_BN2MN*con_BN2MN*connection_prob['HL23BN1HL23MN1']+Ncont_VN2MN*con_VN2MN*connection_prob['HL23VN1HL23MN1']+Ncont_MN2MN*con_MN2MN*connection_prob['HL23MN1HL23MN1'])*gtonic_inhib*100, '%')
			print('BN tonic reduced by ',(Ncont_BN2BN*con_BN2BN*connection_prob['HL23BN1HL23BN1'])/(Ncont_BN2BN*con_BN2BN*connection_prob['HL23BN1HL23BN1']+Ncont_VN2BN*con_VN2BN*connection_prob['HL23VN1HL23BN1']+Ncont_MN2BN*con_MN2BN*connection_prob['HL23MN1HL23BN1'])*gtonic_inhib*100, '%')
			print('VN tonic reduced by ',(Ncont_BN2VN*con_BN2VN*connection_prob['HL23BN1HL23VN1'])/(Ncont_BN2VN*con_BN2VN*connection_prob['HL23BN1HL23VN1']+Ncont_VN2VN*con_VN2VN*connection_prob['HL23VN1HL23VN1']+Ncont_MN2VN*con_MN2VN*connection_prob['HL23MN1HL23VN1'])*gtonic_inhib*100, '%')

			print('New PN tonic ', Gtonic_PN)
			print('New MN tonic ', Gtonic_MN)
			print('New BN tonic ', Gtonic_BN)
			print('New VN tonic ', Gtonic_VN)
